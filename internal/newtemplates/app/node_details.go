...
func (page NodeDetailsPage) HTMXResponse() templ.Component {
...
type NodeDetailsEdit struct {
	cmp.Form
	CourseManagerLayout
}

type NodeDetailsNonEdit struct {
	cmp.EditableInfo
	CourseManagerLayout
}

func (f NodeDetailsEdit) HTMXResponse() templ.Component {
	return f.Form.Component()
}
...
func (f NodeDetailsNonEdit) HTMXResponse() templ.Component {
	return f.EditableInfo.Component()
}
...
func (page NodeDetailsPage) DetailsEdit() NodeDetailsEdit {
	...
	return NodeDetailsEdit{Form: form}
}

func (page NodeDetailsPage) DetailsNonEdit() NodeDetailsNonEdit {
	...
	return NodeDetailsNonEdit{EditableInfo: info}
