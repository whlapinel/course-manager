...
CREATE TABLE IF NOT EXISTS courses (
    ...
    name TEXT NOT NULL,
    description TEXT, std_set_id INTEGER REFERENCES standard_sets(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS term_occasions (
    id INTEGER PRIMARY KEY,
