...
// const scheduleCsvDir = "/home/whlapinel/personal_projects/course_manager/internal/data/csv_files/schedules.csv"
// const newScheduleDir = "/home/whlapinel/personal_projects/course_manager/internal/data/csv_files/schedules_new.csv"
...
// func ImportCoursesFromCSVReader() (domain.Courses, error) {
...
// 	return courses, nil
// }
// func ImportCoursesFromCSVReaderV2(r io.Reader) (domain.Courses, error) {
...
// }
// func WriteCoursesToCSVV2(courses domain.Courses, w io.Writer) error {
// 	if w == nil {
// 		return nil
// 	}
