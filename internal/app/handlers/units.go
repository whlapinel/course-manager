...
func NewUnitHandler(
	...
	return &unitHandler{
		...
		baseHandler: &baseHandler[dto.Unit, int, int]{
			...
			getCreateMarkdown:  routes.GetUnitCreateMarkdown,
			postCreateMarkdown: routes.PostUnitCreateMarkdown,
...
func unitRouteHandlers(h *unitHandler) []web.RouteHandler {
	return []web.RouteHandler{
		...
		web.NewRouteHandler(web.GET, routes.UnitCreateMarkdown, routes.GetUnitCreateMarkdown, h.getCreateMarkdownFile),
		web.NewRouteHandler(web.POST, routes.UnitCreateMarkdown, routes.PostUnitCreateMarkdown, h.postCreateMarkdownFile),
